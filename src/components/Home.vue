...
export default {
  data() {
    return {
      menulist: [],
      iconsObj: {
        125: 'iconfont ic_body icon-ic_body',
        103: 'iconfont ic_box icon-ic_box',
        101: 'iconfont ic_briefcase-1 icon-ic_briefcase-1',
        102: 'iconfont ic_list icon-ic_list',
        145: 'iconfont ic_computer icon-ic_computer'
      },
      isCollapse: false,
      activePath: ''
    }
