<template>
  <div>
      ...
      <el-table :data="orderList" border stripe>
        ...
        <el-table-column label="操作">
          <template>
            ...
            <el-button type="success" icon="el-icon-location" size="mini" @click="showProDia"></el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-pagination
    ...
    <!-- 修改地址对话框 -->
    <el-dialog title="修改地址" :visible.sync="AddDialogVisible" width="50%" @close="resetForm">
      <el-form
        ref="addressFormRef"
        :model="addressForm"
